...
## Usage
Once build, you can launch the program by specifying one of the preset [config file](configFile/) or [create your own config file](documentation/configFileGuide.md).  
```
